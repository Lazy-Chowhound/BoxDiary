...
import example.diary.widget.ResizeRelativeLayout;
import example.diary.widget.RichEditTextView;
...
public class DiaryEditFragment extends BaseFragment<DiaryEditPresenter> implements DiaryEditContract.View, TakePhoto.TakeResultListener, InvokeListener {
    ...
    TextView tvDate;
    @BindView(R.id.spinner_diary_edit_music)
    ...
    protected void initView() {
       ...
       // tvLocation.setText("");
        spinnerMusic.setAdapter(new MusicAdapter());
    ...
    private void save() {
        ...
        entity.setMusic(spinnerMusic.getSelectedItemPosition());
    ...
    class MusicAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.item_diary_music_txt, parent, false);
            TextView iv = (TextView) convertView.findViewById(R.id.iv_item_diary_music);

            iv.setText(ics[position]);
